...
#
# This example shows how to create an Excel export job request, submit it to the job queue, and to
# interact with the resulting Excel export job object returned by the server.
#
...
# use of Excel in exporting data from Granta MI.
