...
# Finally, access the results of the job. Export jobs typically create log _files and either a
# single Excel output file, or a zip containing multiple Excel _files and/or attachments.
...
# In general, an Excel export job will return three _files:
#
...
# * If there are multiple Excel _files generated, or if attachments are included in the export,
# the exported file is a zip of all the exported _files.
